package com.ilinks.interview.model;
...
public class Contact {
	...
	public String toString() {
		return "Contact [id=" + id + ", civil=" + civil + ", nom=" + nom + ", prenom=" + prenom + ", tel=" + tel
				+ ", email=" + email + ", fax=" + fax + ", addr1=" + addr1 + ", addr2=" + addr2 + ", addr3=" + addr3
				+ ", codpos=" + codpos + ", ville=" + ville + ", pays=" + pays + ", natact=" + natact + ", dialang="
				+ dialang + ", ackmail=" + ackmail + ", lastupdate=" + lastupdate + ", lastupdateId=" + lastupdateId
				+ "]";
	}
